		...
		public boolean onTouch(View view, MotionEvent motionEvent) {
			...
			case MotionEvent.ACTION_UP:
				...
				if (underView != null) {
					...
					underViewViewGroup.getLocationOnScreen(location);
					ImageView iv = (ImageView)findViewById(R.id.myimage1);
					int viewX = location[0];
					int viewY = location[1];
					iv.setX(viewX);
					iv.setY(viewY);
					iv.setZ(underViewViewGroup.getZ());
					
					underViewViewGroup.addView(iv);
					underViewViewGroup.bringChildToFront(iv);
					underViewViewGroup.bringToFront();
