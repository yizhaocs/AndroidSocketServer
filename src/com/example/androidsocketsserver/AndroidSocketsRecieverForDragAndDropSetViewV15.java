...
public class AndroidSocketsRecieverForDragAndDropSetViewV15  extends Activity {
	private Boolean exit = false;
	private Boolean isDragging = false;

	private List<View> viewsList;
	// private View movingView = null;
	private AndroidSocketsRecieverForDragAndDropSetViewV15 a = this;
	...
	private OnTouchListener mOnTouchListener = new OnTouchListener() {
		...
		public boolean onTouch(View view, MotionEvent motionEvent) {
			...
			case MotionEvent.ACTION_UP:
				...
				Log.d("movingObject", "x1:" + String.valueOf(motionEvent.getX()) + "  ,y1:" + String.valueOf(motionEvent.getY()));
				Log.d("movingObject", "x2:" + String.valueOf(x) + "  ,y2:" + String.valueOf(y));
				Log.d("movingObject", "x3:" + String.valueOf((int) (motionEvent.getRawX() - view.getWidth() / 2)) + "  ,y3:" + String.valueOf((int) (motionEvent.getRawY() - view.getHeight() - view.getHeight() / 2)));
				
				
				View underView = findView((int) (motionEvent.getRawX() - view.getWidth() / 2), (int) (motionEvent.getRawY() - view.getHeight() - view.getHeight() / 2), rootView);
...
//					iv.setX(motionEvent.getRawX() - view.getWidth() / 2);
//					iv.setY(motionEvent.getRawY() - view.getHeight() - view.getHeight() / 2);
					iv.setId(view.getId());
